...
// Hash: 3f4e5e9d12e9916f534222ba15dedb0012d53bce5ef7ebc2d1b9e8ef61dd0a65
package genesis
...
func (a *AggregateAndProof) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if size := len(a.SelectionProof); size != 96 {
		err = ssz.ErrBytesLengthFn("AggregateAndProof.SelectionProof", size, 96)
		return
	}
...
func (a *AttestationData) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (0) 'Slot'
	dst = ssz.MarshalUint32(dst, a.Slot)
...
func (a *AttestationData) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'Slot'
	a.Slot = ssz.UnmarshallUint32(buf[0:4])

	// Field (1) 'Index'
	a.Index = ssz.UnmarshallUint64(buf[4:12])

	// Field (2) 'BeaconBlockHash'
	copy(a.BeaconBlockHash[:], buf[12:44])

	// Field (3) 'Source'
	if a.Source == nil {
		a.Source = new(Checkpoint)
	}
	if err = a.Source.UnmarshalSSZ(buf[44:84]); err != nil {
		return err
	}
	...
	if err = a.Target.UnmarshalSSZ(buf[84:124]); err != nil {
		return err
	}
...
func (a *Attestation) UnmarshalSSZ(buf []byte) error {
	...
	if err = a.Data.UnmarshalSSZ(buf[4:128]); err != nil {
		return err
	}

	// Field (2) 'Signature'
	if cap(a.Signature) == 0 {
		a.Signature = make([]byte, 0, len(buf[128:224]))
	}
	a.Signature = append(a.Signature, buf[128:224]...)
...
func (i *IndexedAttestation) UnmarshalSSZ(buf []byte) error {
	...
	if err = i.Data.UnmarshalSSZ(buf[4:128]); err != nil {
		return err
	}

	// Field (2) 'Signature'
	if cap(i.Signature) == 0 {
		i.Signature = make([]byte, 0, len(buf[128:224]))
	}
	i.Signature = append(i.Signature, buf[128:224]...)
...
func (p *PendingAttestation) UnmarshalSSZ(buf []byte) error {
	...
	if err = p.Data.UnmarshalSSZ(buf[4:128]); err != nil {
		return err
	}

	// Field (2) 'InclusionDelay'
	p.InclusionDelay = ssz.UnmarshallUint64(buf[128:136])

	// Field (3) 'ProposerIndex'
	p.ProposerIndex = ssz.UnmarshallUint64(buf[136:144])
...
func (v *ValidatorSet) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Offset (0) 'Set'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(v.Set) * 121

	// Field (0) 'Set'
	if size := len(v.Set); size > 1099511627776 {
		err = ssz.ErrListTooBigFn("ValidatorSet.Set", size, 1099511627776)
		return
	}
	for ii := 0; ii < len(v.Set); ii++ {
		if dst, err = v.Set[ii].MarshalSSZTo(dst); err != nil {
			return
		}
	}
...
func (v *ValidatorSet) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'Set'
	{
		...
		v.Set = make([]*Validator, num)
		for ii := 0; ii < num; ii++ {
			if v.Set[ii] == nil {
				v.Set[ii] = new(Validator)
			}
			if err = v.Set[ii].UnmarshalSSZ(buf[ii*121 : (ii+1)*121]); err != nil {
				return err
			}
		}
	}
